...
class TopRatedMovie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) =>
          instance<MovieCubit>()..getTopRatedMovie(),
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                StringManger.topRatedMovie,
                style: Theme.of(context).textTheme.headlineLarge,
              ),
              centerTitle: true,
            ),
            body: _topRatedMovieWidget(topRated, context),
          );
        },
      ),
    );
  ...
  Widget _topRatedMovieWidget(List<MovieModel> item, context) {
